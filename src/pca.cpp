...
void PCA::fit(SparseMatrix X) {
    ...
    std::pair<Eigen::VectorXd, Matrix> autovects = get_first_eigenvalues(M,
                                                                         this->n_components); //me quedo con los primeros autovects (las n_components componentes principales)
